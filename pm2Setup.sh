...
if [ "$BITS" = 32 ]; then
	echo -e "Your system architecture is $ARCH which is unsupported to run Pixlz. \nYour OS: $OS \nOS Version: $VER"
	rm pm2Setup.sh
	exit 1
fi


echo -e "Welcome to pm2 setup! \nWould you like to continue? \nYour OS: $OS \nOS Version: $VER \nArchitecture: $ARCH"

while true; do
    read -p "[y/n]: " yn
    case $yn in
        [Yy]* ) clear; echo Running pm2 Setup; sleep 2; break;;
        [Nn]* ) echo Quitting...; rm pm2Setup.sh && exit;;
